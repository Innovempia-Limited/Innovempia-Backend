  ...
  async sendStudentOnboarding(email: string, firstName: string, courseTitle: string) {
    const content = `
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin: 28px 0;">
        <tr>
          <td align="center">
            <a href="https://www.innovempia.com/dashboard" target="_blank" style="background-color: #4F46E5; color: #ffffff; text-decoration: none; padding: 14px 36px; border-radius: 50px; font-weight: 600; font-size: 15px; display: inline-block; box-shadow: 0 6px 20px rgba(79, 70, 229, 0.35);">Go to My Dashboard</a>
          </td>
        </tr>
      </table>
